<template>
	<view class="content" style="margin-top: 60px;">
		<view class="search-box">
			...
			<!-- 
			* <mSearch :mode="2" button="inside" :placeholder="'搜索活动'" @search="doSearch(false)" @input="inputChange" @confirm="doSearch(false)" v-model="keyword"></mSearch>
			* -->
		</view>
			...
			<scroll-view class="keyword-box"  scroll-y>
				...
				<view class="keyword-block">
					<view class="keyword-list-header">
						...
						<view>
							<image @tap="freshKeyWord" src="/static/HM-search/delete.png"></image>
						</view>
					</view>
